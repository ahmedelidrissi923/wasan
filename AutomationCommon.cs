...
namespace WASender
{
    public class AutomationCommon
    {
        ...
        public static void ChangeCampStatus(CampaignStatusEnum _campaignStatus, Label lblRunStatus)
        {
            ...
            else if (_campaignStatus == CampaignStatusEnum.GettingEmailIds)
            {
                lblRunStatus.ForeColor = Color.Green;
                lblRunStatus.Text = Strings.GettignEmailIds;
            }
            else if (_campaignStatus == CampaignStatusEnum.NoPollFound)
            {
                lblRunStatus.ForeColor = Color.Red;
                lblRunStatus.Text = Strings.NoPollsfound;
            }
        }
        ...
        public static void ChangeInitStatus(InitStatusEnum _initStatus, Label lblInitStatus)
        {
            ...
            else if (_initStatus == InitStatusEnum.Error_Click_on_Start)
            {
                lblInitStatus.ForeColor = Color.Red;
                lblInitStatus.Text = Strings.ErrorClickonStartButtonagain;
            }
