...
namespace WASender
{
    public class Strings
    {
        ...
        public readonly static bool Group_Warmer                        = true; // Set true to false if you dont want this tool to be appear in Tools Section
        public readonly static bool Bulk_Group_Links_Verify             = true; // Set true to false if you dont want this tool to be appear in Tools Section
        /// </summary>
        ...
        public readonly static string WhatsAppGroupWarmer = GetValue("WhatsAppGroupWarmer");
        public readonly static string SelectedAccountsDonthaveanyGroupInCommon = GetValue("SelectedAccountsDonthaveanyGroupInCommon");
        public readonly static string CommonGroups = GetValue("CommonGroups");
        public readonly static string GettingyourGroups = GetValue("GettingyourGroups");
        public readonly static string SelectGrouptowarmingup = GetValue("SelectGrouptowarmingup");
        public readonly static string UnfortunatelywithfilesyoucanonlyplaceTwobuttons = GetValue("UnfortunatelywithfilesyoucanonlyplaceTwobuttons");
        public readonly static string General = GetValue("General");
        public readonly static string MessageSending = GetValue("MessageSending");
        public readonly static string GoogleMapExtractor = GetValue("GoogleMapExtractor");
        public readonly static string GoogleMapUI = GetValue("GoogleMapUI");
        public readonly static string NEWUI = GetValue("NEWUI");
        public readonly static string datawillbescrappedacordingtonewGoogleMapUI = GetValue("datawillbescrappedacordingtonewGoogleMapUI");
        public readonly static string OldClassicUI = GetValue("OldClassicUI");
        public readonly static string datawillbescrappedacordingtooldClassicgooglemapUI = GetValue("datawillbescrappedacordingtooldClassicgooglemapUI");
        public readonly static string IntheGoogleMapNewUInewdataloadedafterpagescroll = GetValue("IntheGoogleMapNewUInewdataloadedafterpagescroll");
        public readonly static string State = GetValue("State");
        public readonly static string City = GetValue("City");
        public readonly static string GrabEmailIdaftercompletinfetchingalldata = GetValue("GrabEmailIdaftercompletinfetchingalldata");
        public readonly static string GettignEmailIds = GetValue("GettignEmailIds");
        public readonly static string Setting = GetValue("Setting");
        public readonly static string Applythisproxytoselectedaccount = GetValue("Applythisproxytoselectedaccount");
        public readonly static string AccountSettings = GetValue("AccountSettings");
        public readonly static string Proxy = GetValue("Proxy");
        public readonly static string ProxyServer = GetValue("ProxyServer");
        public readonly static string Port = GetValue("Port");
        public readonly static string UserName = GetValue("UserName");
        public readonly static string Password = GetValue("Password");
        public readonly static string TestConnection = GetValue("TestConnection");
        public readonly static string Pleaseproviderequiredinputs = GetValue("Pleaseproviderequiredinputs");
        public readonly static string Connecting = GetValue("Connecting");
        public readonly static string ProxySettingsaresavedSuccessfully = GetValue("ProxySettingsaresavedSuccessfully");
        public readonly static string BulkGroupLinksVerify = GetValue("BulkGroupLinksVerify");
        public readonly static string GroupLinks = GetValue("GroupLinks");
        public readonly static string LinkCheck = GetValue("LinkCheck");
        public readonly static string MembersCount = GetValue("MembersCount");
        public readonly static string Participants = GetValue("Participants");
        public readonly static string IsAnnouncementGroup = GetValue("IsAnnouncementGroup");
        public readonly static string Paste = GetValue("Paste");
        public readonly static string RemoveDuplicate = GetValue("RemoveDuplicate");
        public readonly static string Media = GetValue("Media");
        public readonly static string Location = GetValue("Location");
        public readonly static string Contact = GetValue("Contact");
        public readonly static string AudioRecording = GetValue("AudioRecording");
        public readonly static string Sticker = GetValue("Sticker");
        public readonly static string VideoNote = GetValue("VideoNote");
        public readonly static string Audio = GetValue("Audio");
        public readonly static string AtachLocation = GetValue("AtachLocation");
        public readonly static string Latitute = GetValue("Latitute");
        public readonly static string Longitude = GetValue("Longitude");
        public readonly static string NameofLocationoptional = GetValue("NameofLocationoptional");
        public readonly static string Addressoptional = GetValue("Addressoptional");
        public readonly static string URLoptional = GetValue("URLoptional");
        public readonly static string Pleaseprovidemandatorydetails = GetValue("Pleaseprovidemandatorydetails");
        public readonly static string AddAtachment = GetValue("AddAtachment");
        public readonly static string Cantsetcaptionorcantatachitwithmainmessagetononmediatypeofatachments = GetValue("Cantsetcaptionorcantatachitwithmainmessagetononmediatypeofatachments");
        public readonly static string AttachContact = GetValue("AttachContact");
        public readonly static string ContactName = GetValue("ContactName");
        public readonly static string ContactNumberwithcountrycode = GetValue("ContactNumberwithcountrycode");
        public readonly static string DataExtractors = GetValue("DataExtractors");
        public readonly static string Grouptools = GetValue("Grouptools");
        public readonly static string AutomationsFiltrations = GetValue("AutomationsFiltrations");
        public readonly static string LeadGenerationtools = GetValue("LeadGenerationtools");
        public readonly static string ErrorClickonStartButtonagain = GetValue("ErrorClickonStartButtonagain");
        public readonly static string NoPollsfound = GetValue("NoPollsfound");
        ...
        #region donnotchange
        public readonly static string SoftwareVersion = "3.6.0"; /// Dont change this
        public readonly static int CurrentInternalUpdateVersion = 3; //It Should be same as listed in onlie file 
        #endregion
        ...
        public static string getLanguage(LanguagesEnum enumLang)
        {
            ...
            else if (enumLang == LanguagesEnum.Azerbaijani)
            {
                return "Azerbaijani";
            }
            return "English";
